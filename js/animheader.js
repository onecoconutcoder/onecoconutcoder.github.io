...
!function(t, e) {
    ...
    if (!i.TweenLite) {
        var n, s, r, a, o, h = function(t) {
            ...
            this.check = function(l) {
                for (var _, u, c, p, d = s.length, g = d; --d > -1; )
                    (_ = f[s[d]] || new m(s[d],[])).gsClass ? (o[d] = _.gsClass,
                    g--) : l && _.sc.push(this);
                if (0 === g && r)
                    for (u = ("com.greensock." + n).split("."),
                    c = u.pop(),
        ...
        r.addEventListener = function(t, e, i, n, s) {
            ...
            h = l.length; --h > -1; )
                r = l[h],
                r.c === e && r.s === i ? l.splice(h, 1) : 0 === _ && s > r.pr && (_ = h + 1);
            l.splice(_, 0, {
                c: e,
                s: i,
                up: n,
        ...
        s = n.length; --s > -1 && !S; )
            ...
            k = t[n[s] + "CancelAnimationFrame"] || t[n[s] + "CancelRequestAnimationFrame"];
        ...
        var I = g("TweenLite", function(e, i, n) {
            ...
            if (this._overwrite = h = null == h ? U[I.defaultOverwrite] : "number" == typeof h ? h >> 0 : U[h],
            (o || e instanceof Array || e.push && p(e)) && "number" != typeof e[0])
                ...
                s = 0; a.length > s; s++)
                    ...
                    this._targets = a = a.concat(u(r))) : (this._siblings[s] = X(r, this, !1),
                    1 === h && this._siblings[s].length > 1 && Y(r, this, null, 1, this._siblings[s])) : (r = a[s--] = I.selector(r),
          ...
          , O = function(t, e) {
            var i, n = {};
            for (i in t)
                N[i] || i in e && "transform" !== i && "x" !== i && "y" !== i && "width" !== i && "height" !== i && "className" !== i && "border" !== i || !(!L[i] || L[i] && L[i]._autoCSS) || (n[i] = t[i],
                delete t[i]);
            t.css = n
        };
        r = I.prototype = new R,
        ...
        R._updateRoot = I.render = function() {
            ...
            !(a.frame % 120)) {
                ...
                if (i = G._first,
                (!i || i._paused) && I.autoSleep && !j._first && 1 === a._listeners.tick.length) {
                    for (; i && i._paused; )
                        i = i._next;
                    i || a.sleep()
                }
        ...
        var X = function(t, e, i) {
          ...
          , Y = function(t, e, i, n, s) {
            ...
            for (r = s.length; --r > -1; )
                (o = s[r]) === e || o._gc || o._paused || (o._timeline !== e._timeline ? (l = l || H(e, 0, f),
                0 === H(o, l, f) && (c[p++] = o)) : u >= o._startTime && o._startTime + o.totalDuration() / o._timeScale > u && ((f || !o._initted) && 2e-10 >= u - o._startTime || (c[p++] = o)));
            for (r = p; --r > -1; )
                o = c[r],
                2 === n && o._kill(i, t) && (a = !0),
          ...
          , H = function(t, e, i) {
            ...
            return r /= s,
            r > e ? r - e : i && r === e || !t._initted && 2 * _ > r - e ? _ : (r += t.totalDuration() / t._timeScale / s) > e + _ ? 0 : r - e - _
        };
        r._init = function() {
            ...
            if (this._ease = l = l ? l instanceof y ? l : "function" == typeof l ? new y(l,r.easeParams) : T[l] || I.defaultEase : I.defaultEase,
            r.easeParams instanceof Array && l.config && (this._ease = l.config.apply(l, r.easeParams)),
        ...
        r._initProps = function(e, i, n, s) {
            ...
            if (null == e)
                return !1;
            z[e._gsTweenID] && Q(),
            this.vars.css || e.style && e !== t && e.nodeType && L.css && this.vars.autoCSS !== !1 && O(this.vars, e);
            for (r in this.vars) {
                if (_ = this.vars[r],
                N[r])
                    _ && (_ instanceof Array || _.push && p(_)) && -1 !== _.join("").indexOf("{self}") && (this.vars[r] = _ = this._swapSelfInParams(_, this));
            ...
            return s && this._kill(s, e) ? this._initProps(e, i, n, s) : this._overwrite > 1 && this._firstPT && n.length > 1 && Y(e, this, i, this._overwrite, n) ? (this._kill(i, e),
            this._initProps(e, i, n, s)) : (this._firstPT && (this.vars.lazy !== !1 && this._duration || this.vars.lazy && !this._duration) && (z[e._gsTweenID] = !0),
            o)
        }
        ,
        r.render = function(t, e, i) {
            ...
            if (t >= h)
                ...
                (0 === t || 0 > l || l === _) && l !== t && (i = !0,
                l > _ && (s = "onReverseComplete")),
                this._rawPrevTime = a = !e || t || l === t ? t : _);
            else if (1e-7 > t)
                this._totalTime = this._time = 0,
                this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0,
                (0 !== o || 0 === h && l > 0 && l !== _) && (s = "onReverseComplete",
                n = this._reversed),
                0 > t ? (this._active = !1,
            ...
            if (this._time !== o || i) {
                ...
                this.vars.onStart && (0 !== this._time || 0 === h) && (e || this.vars.onStart.apply(this.vars.onStartScope || this, this.vars.onStartParams || w))),
                r = this._firstPT; r; )
                ...
                e || (this._time !== o || n) && this._onUpdate.apply(this.vars.onUpdateScope || this, this.vars.onUpdateParams || w)),
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
    ...
    _gsScope._gsDefine("easing.Back", ["easing.Ease"], function(t) {
        ...
        i = h("easing.RoughEase", function(e) {
            e = e || {};
            for (var i, n, s, r, a, o, h = e.taper || "none", l = [], _ = 0, u = 0 | (e.points || 20), p = u, f = e.randomize !== !1, m = e.clamp === !0, d = e.template instanceof t ? e.template : null, g = "number" == typeof e.strength ? .4 * e.strength : .4; --p > -1; )
                i = f ? Math.random() : 1 / u * p,
                n = d ? d.getRatio(i) : i,
                "none" === h ? s = g : "out" === h ? (r = 1 - i,
                s = r * r * g) : "in" === h ? s = i * i * g : .5 > i ? (r = 2 * i,
                s = .5 * r * r * g) : (r = 2 * (1 - i),
                s = .5 * r * r * g),
...
function() {
    function t() {
        ...
        p = document.getElementById("page-header"),
        p.style.height = c + "px",
    ...
    function i(t) {
        ...
        posy = t.pageY) : (t.clientX || t.clientY) && (e = t.clientX + document.body.scrollLeft + document.documentElement.scrollLeft,
    ...
    function a() {
        if (v) {
            m.clearRect(0, 0, u, c);
            for (var t in d)
                Math.abs(_(g, d[t])) < 4e3 ? (d[t].active = .3,
                d[t].circle.active = .6) : Math.abs(_(g, d[t])) < 2e4 ? (d[t].active = .1,
                d[t].circle.active = .3) : Math.abs(_(g, d[t])) < 4e4 ? (d[t].active = .02,
                d[t].circle.active = .1) : (d[t].active = 0,
                d[t].circle.active = 0),
                h(d[t]),
                d[t].circle.draw()
        }
    ...
    function h(t) {
        if (t.active)
            for (var e in t.closest)
                ...
                m.strokeStyle = "rgba(156,217,249," + t.active + ")",
                m.stroke()
    }
    function l(t, e, i) {
        var n = this;
        ...
        this.draw = function() {
            n.active && (m.beginPath(),
            m.arc(n.pos.x, n.pos.y, n.radius, 0, 2 * Math.PI, !1),
            m.fillStyle = "rgba(156,217,249," + n.active + ")",
            m.fill())
        }
    }
    function _(t, e) {
